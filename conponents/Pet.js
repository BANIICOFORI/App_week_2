  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.location}>
             ...
             <EvilIcons style={styles.location} name="location" size={24} color="black"/><Text numberOfLines={1} >932 sharene Nicholas</Text></View>
        ...
        <View style={styles.location}>
             ...
             <EvilIcons style={styles.location} name="location" size={24} color="black"/><Text numberOfLines={1} style={styles.location}>932 sharene sharene Nicholas</Text></View>
        ...
        <View style={styles.location}>
             ...
             <EvilIcons name="location" size={24} color="black"/><Text numberOfLines={1}  style={styles.location}>932 sharene sharene Nicholas</Text></View>
